...
public class Main {
    public static void main(String[] args) {
        ...
        Serie s = new Serie("Dr. House", "Série", 8, 177);
        s.diretor = new Pessoa("David Shore", "Canadense");
        s.setArtistas(new Pessoa("Hugh Laurie", "Inglês"));
        series.add(s);

        s = new Serie("Breaking Bad", "Série", 5, 62);
        s.diretor = new Pessoa("Vince Gilligan", "Norte Americano");
        s.setArtistas(new Pessoa("Bryan Cranston", "Norte Americano"));
        s.setArtistas(new Pessoa("Aaron Paul", "Norte Americano"));
        series.add(s);
